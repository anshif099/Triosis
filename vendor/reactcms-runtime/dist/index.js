      ...
      children: /* @__PURE__ */ jsx(
        EditableRegistryContext.Provider,
        {
          ...
          children: /* @__PURE__ */ jsxs(CMSProvider, { websiteId, apiKey, environment: "production", children: [
            children,
            isPreviewMode && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsxs(
                "div",
                {
                  style: {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "12px" }, children: [
                      /* @__PURE__ */ jsxs("span", { style: { display: "flex", alignItems: "center", gap: "6px", background: "#1e293b", padding: "3px 10px", borderRadius: "20px", fontSize: "11px", fontWeight: 600, color: "#38bdf8" }, children: [
                        /* @__PURE__ */ jsx("span", { children: "\u270F\uFE0F" }),
                        " ReactCMS Visual Editor"
                      ] }),
                      /* @__PURE__ */ jsx("span", { style: { fontSize: "11px", color: "#64748b" }, children: "Draft auto-saves in real-time" })
                    ] }),
                    /* @__PURE__ */ jsx("div", { style: { display: "flex", alignItems: "center", gap: "12px" }, children: publishedToast ? /* @__PURE__ */ jsx("span", { style: { color: "#4ade80", fontWeight: "bold", fontSize: "12px", display: "flex", alignItems: "center", gap: "6px" }, children: "\u2713 Published Live! Changes are live on your site!" }) : /* @__PURE__ */ jsx(
                      "button",
                      {
                        type: "button",
