...
__export(index_exports, {
  CURRENT_DASHBOARD_VERSION: () => CURRENT_DASHBOARD_VERSION,
  CURRENT_RUNTIME_VERSION: () => CURRENT_RUNTIME_VERSION,
  CURRENT_SDK_VERSION: () => CURRENT_SDK_VERSION,
  EVENT_TYPES: () => EVENT_TYPES,
  FIREBASE_ROOTS: () => FIREBASE_ROOTS,
  decodeFirebaseKey: () => decodeFirebaseKey,
  decodeFirebaseObject: () => decodeFirebaseObject,
  encodeFirebaseKey: () => encodeFirebaseKey,
  encodeFirebaseObject: () => encodeFirebaseObject,
  paths: () => paths,
