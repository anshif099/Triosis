...
function NodeFrame({
  ...
  const [insertTextType, setInsertTextType] = (0, import_react.useState)("paragraph");
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px" }, children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: "8px", color: "#94a3b8", fontSize: "14px" }, children: [
                        "It will be inserted ",
                        insertPosition,
                        " this section."
                      ] })
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "10px", margin: "26px 0" }, children: ["paragraph", "button", "image", "video"].map((type) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    "button",
                    {
                      type: "button",
                  ...
                  insertType === "paragraph" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "grid", gap: "20px" }, children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { display: "grid", gap: "10px", color: "#cbd5e1", fontWeight: 700 }, children: [
                      "Text",
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { display: "grid", gap: "10px", color: "#cbd5e1", fontWeight: 700 }, children: [
                      "Text type",
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", { value: insertTextType, onChange: (event) => setInsertTextType(event.target.value), style: { height: "54px", padding: "0 16px", border: "1px solid #334155", borderRadius: "14px", background: "#030d1d", color: "#f8fafc", font: "inherit" }, children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "paragraph", children: "Paragraph - Normal text" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "h1", children: "H1 - Main page heading" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "h2", children: "H2 - Section heading" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "h3", children: "H3 - Subsection heading" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "h4", children: "H4 - Heading level 4" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "h5", children: "H5 - Heading level 5" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "h6", children: "H6 - Heading level 6" })
                      ] }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: "#64748b", fontSize: "12px", fontWeight: 400 }, children: "The selected heading level automatically uses its matching default size." })
                    ] })
                  ] }) : insertType === "button" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "grid", gap: "14px" }, children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { display: "grid", gap: "7px", color: "#cbd5e1", fontWeight: 700 }, children: [
                      "Button label",
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { autoFocus: true, required: true, value: insertText, onChange: (event) => setInsertText(event.target.value), placeholder: "Contact us", style: { height: "48px", padding: "0 14px", border: "1px solid #334155", borderRadius: "10px", background: "#030d1d", color: "#f8fafc", font: "inherit" } })
                    ] }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { display: "grid", gap: "7px", color: "#cbd5e1", fontWeight: 700 }, children: [
                      "Destination",
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { required: true, value: insertUrl, onChange: (event) => setInsertUrl(event.target.value), placeholder: "/about or https://example.com", style: { height: "48px", padding: "0 14px", border: "1px solid #334155", borderRadius: "10px", background: "#030d1d", color: "#f8fafc", font: "inherit" } })
                    ] })
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", justifyContent: "flex-end", gap: "9px", marginTop: "22px" }, children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "submit", style: { height: "48px", padding: "0 24px", border: 0, borderRadius: "10px", background: "#d9362e", color: "#fff", cursor: "pointer", fontWeight: 800 }, children: "Add to page" })
                  ] })
                ]
              }
            )
